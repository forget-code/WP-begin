...
<?php if (function_exists( 'is_shop' )) { ?><?php if (zm_get_option('woo')) { ?><?php if ( is_shop('')) { ?><title><?php echo trim( wp_title( '',0 ) ); ?> <?php echo zm_get_option('connector'); ?> <?php bloginfo('name'); ?></title><?php } ?><?php } ?><?php } ?>
