<table cellspacing="0" cellpadding="0" border="0">
	<thead>
		<tr>
			<td width="500"><?php _e( '标题', 'begin' ); ?></td>
			<td width="120"><?php _e( '日期', 'begin' ); ?></td>
			<td width="100"><?php _e( '浏览', 'begin' ); ?></td>
			<td width="120"><?php _e( '分类', 'begin' ); ?></td>
			<td width="100"><?php _e( '评论', 'begin' ); ?></td>
			<td width="80"><?php _e( '状态', 'begin' ); ?></td>
		</tr>
	</thead>
	<tbody>
		<?php
